...
def main(parameters):
        ...
        dataset_name="MineRLTreechopVectorObf-v0"
        env=load_env(dataset_name,record=parameters["record"],vectorize_actions=parameters["vectorize_actions"])
        device="cuda"
        state_dim= 3*64*64
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pov_encoder', type=bool, default=False)
