...
class BufferedTrajectoryIter:#TODO, add another version that samples whithout repetition
        def __init__(self,
                 data_pipeline,
                 buffer_target_size=5000,sequence_size=1,reward_to_go=False,reward_to_go_dictionary={},max_ep_len_dataset=100000,store_rewards2go=True,all_trajectories=None):
